...
export default (): JSX.Element => (
  <footer className="pv2 ph3 ph5-ns tc sans-serif">
    <p>Check me out on:</p>
    <a
      className="link near-black hover-gold dib h2 w2 mr2 ml2"
      href="https://github.com/andreasknoepfle"
      title="GitHub"
    >
      <svg
        fill="currentColor"
    ...
    <a
      className="link hover-gold near-black dib h2 w2 mr2 ml2"
      href="https://stackoverflow.com/users/2389628/smallbutton"
    ...
    <a
      className="link hover-gold near-black dib h2 w2 mr2 ml2"
      href="https://www.linkedin.com/in/andreasknoepfle"
      title="LinkedIn"
    >
      <svg
        fill="currentColor"
    ...
    <a
      className="link hover-gold near-black dib h2 w2 mr2 ml2"
      href="https://twitter.com/andreasknoepfle"
      title="Twitter"
    >
      <svg
        fill="currentColor"
    ...
    <a
      className="link hover-gold near-black dib h2 w2 mr2 ml2"
      href="https://keybase.io/andreasknoepfle"
      title="Keybase"
    >
      <svg
        fill="currentColor"
